...
const DATASETS = [
  ...
  { name: 'Mitra Darat (Trans Jogja, Trans Jateng, Trans Batam, Trans Jatim, Suroboyo Bus, dan kota-kota lain — lihat halaman Moda Transportasi untuk daftar lengkap)', format: 'JSON',
    ...
    <ul style={{
      ...
      {DATASETS.map(d => (
        <li key={d.url} style={{
          ...
          <div style={{ flex: '1 1 260px', fontSize: '0.85rem', color: 'var(--text)', lineHeight: 1.5 }}>
            {d.name}
          </div>
...
function Disclaimer() {
  return (
    <>
      ...
      <p style={{ fontSize: '0.85rem', color: 'var(--text-dim)', lineHeight: 1.6, margin: '0 0 24px' }}>
  ...
  return (
    <>
      ...
      <p style={{ fontSize: '0.85rem', color: 'var(--text-dim)', lineHeight: 1.6, margin: 0 }}>
        ...
        <a href="https://creativecommons.org/licenses/by-nc/4.0/deed.id"
           target="_blank" rel="noopener noreferrer"
           style={{ color: 'var(--accent)', textDecoration: 'underline' }}>
          Attribution-NonCommercial 4.0
        </a>. Hak atas data aslinya tetap berada pada masing-masing operator transportasi.
      </p>
    </>
  )
}
  ...
  return (
    <div onClick={onClose} style={{
      ...
      <div onClick={(e) => e.stopPropagation()} style={{
        ...panel, width: '100%', maxWidth: 640, maxHeight: '90vh',
        overflow: 'auto', padding: 28, fontFamily: "'Outfit', sans-serif",
      }}>
        ...
        <p style={{ fontSize: '0.9rem', color: 'var(--text)', lineHeight: 1.6, margin: '0 0 12px' }}>
          Opentransum berkomitmen untuk membagikan data transportasi umum secara terbuka
          kepada publik.
        </p>
        <p style={{ fontSize: '0.9rem', color: 'var(--text)', lineHeight: 1.6, margin: '0 0 22px' }}>
