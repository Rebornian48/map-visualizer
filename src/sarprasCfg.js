// Extracted from src/sarpras.js so the MapLibre globe view can import
// SARPRAS_CFG without dragging Leaflet in. sarpras.js re-exports the
// same symbols so the Leaflet side keeps its imports unchanged.
