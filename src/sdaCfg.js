// Extracted from src/sda.js — same reason as sarprasCfg.js: keep this
// Leaflet-free so the MapLibre globe can import SDA_CFG without pulling
// Leaflet into the initial-load module preload graph.
